...
//		            float width = getPaint().measureText(getHint().toString());
//		            final float hintPosX = getRight() + getScrollX() - getCompoundPaddingRight() - (width)-25;
//		            mFloatingHintPaint.setTextSize(getTextSize());
...
//    			}
        ...
        float width = getPaint().measureText(getHint().toString());
        final float hintPosX = getRight() + getScrollX() - getCompoundPaddingRight() - (width * mHintScale);
